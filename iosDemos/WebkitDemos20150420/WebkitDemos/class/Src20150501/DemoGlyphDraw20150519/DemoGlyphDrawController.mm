...
///< 私有方法
@interface DemoGlyphDrawController()
{
	
}

@property (nonatomic, retain) DemoGlyphDrawView * subDemoView;
...
@implementation DemoGlyphDrawController
...
- (void)addSubViewObject
{
	...
	self.subDemoView = [[[DemoGlyphDrawView alloc] initWithFrame:frame] autorelease];
