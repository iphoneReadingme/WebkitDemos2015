 ...
 */
@interface NBFontDescriptor : NSObject <NSCopying, NSCoding>
...
/**
 A call to the method is ideally placed into your app delegate. This loads all available system fonts into a look up table to allow CoreText to quickly find a specific combination of font-family and italic and bold attributes. Please refer to the [Programming Guide](../docs/Programming%20Guide.html) for information when you should be using this.
 
 Calling this does not replace entries already existing in the lookup table, for example loaded from the `CoreTextFontOverrides.plist` included in the app bundle.
 */
